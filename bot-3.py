...
"""
import os, json, sqlite3, logging, math, re, requests
...
async def cmd_start(u: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    kb = [
        [InlineKeyboardButton("📦 Astatka", callback_data='stock'),
        ...
        [InlineKeyboardButton("🚚 Yo'lda", callback_data='transit'),
         InlineKeyboardButton("💳 Zavod qarzi", callback_data='supplier_debt')],
        [InlineKeyboardButton("💵 Narxlar", callback_data='prices'),
         InlineKeyboardButton("📊 Analiz", callback_data='analiz')],
        [InlineKeyboardButton("👥 Mijozlar", callback_data='customers'),
         InlineKeyboardButton("💳 Qarzlar", callback_data='debts')],
        [InlineKeyboardButton("💸 Xarajatlar", callback_data='expenses'),
         InlineKeyboardButton("🎯 Maqsad", callback_data='target')],
        [InlineKeyboardButton("🔧 Kafolat", callback_data='warranties'),
         InlineKeyboardButton("📈 Trend", callback_data='trend')],
        [InlineKeyboardButton("💵 Cash Flow", callback_data='cashflow'),
         InlineKeyboardButton("📢 OLX", callback_data='olx')],
        [InlineKeyboardButton("➕ Yangi tovar", callback_data='new_product'),
         InlineKeyboardButton("↩️ Qayt etish", callback_data='undo_list')],
    ]
